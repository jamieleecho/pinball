...
![Lost World Pinball on the CoCo 3: the ball loose on the left of the table, both flippers at rest, the diamonds and the drop targets waiting, and Vally keeping score on the panel alongside](doc/screenshot.png)
